...
# Scrapy settings for topman project
#
...
SPIDER_MODULES = ['topman.spiders']
NEWSPIDER_MODULE = 'topman.spiders'
...
#SPIDER_MIDDLEWARES = {
#    'topman.middlewares.TopmanSpiderMiddleware': 543,
#}
...
IMAGES_STORE = '/home/janis/dev/garms_data/data_uk/topman_uk/images/dec_2019'
